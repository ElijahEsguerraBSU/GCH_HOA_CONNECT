...
function showSuccessToast(message) {
    const toastId = 'appointment_toast_success';
    
    // Use the notification-toast component's show function
    try {
...
function showErrorToast(message) {
    const toastId = 'appointment_toast_error';
    
    // Update error message slot
    const messageSlot = document.getElementById('appointment-error-message-slot');
    if (messageSlot) {
