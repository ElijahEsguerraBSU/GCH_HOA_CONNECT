...
$(document).ready(function() {
    // CRITICAL: Skip calendar initialization on appointment-calendar page
    ...
    if (window.location.pathname.includes('appointment-calendar') || 
        ...
        console.log('Skipping default calendar.js initialization - appointment calendar page detected');
        return;
    }
