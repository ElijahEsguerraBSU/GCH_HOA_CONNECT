    ...
    detailsContainer.innerHTML = `
        <div class="px-6 py-8">
            ...
            <div class="mb-6">
                ...
                <div class="form-control mt-2 pr-1 pl-0 py-1 border border-slate-300 rounded-lg bg-slate-50 text-slate-700" style="padding-left: 0 !important; text-align: left;">
...
function displayFeedbackDetails(feedback) {
    ...
    detailsContainer.innerHTML = `
        <div class="px-6 py-8">
            ...
            <div class="mb-6">
                <label class="form-label text-base font-semibold text-slate-700">Feedback Description</label>
                <div class="form-control mt-2 pr-1 pl-0 py-1 border border-slate-300 rounded-lg bg-slate-50 text-slate-700 max-h-64 overflow-y-auto overflow-x-hidden" style="word-wrap: break-word; white-space: pre-wrap; overflow-wrap: break-word; padding-left: 0 !important; text-align: left;">
                    ${feedback.description || 'No description provided'}
                </div>
            </div>
