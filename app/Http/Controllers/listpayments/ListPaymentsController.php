...
class ListPaymentsController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Description filter
        if ($request->has('description') && $request->description !== 'all') {
            $description = $request->description;
            $query->whereHas('billingItems', function($q) use ($description) {
    ...
    public function approve(Request $request, $id)
    {
        try {
            ...
            try {
                ...
                // Users who make payments have notifications enabled for "billing payment" module
                ...
                \Log::info('Payment approval notification - Module lookup', [
            ...
            return response()->json([
                ...
                'notification' => [
                    ...
                    'message' => 'Your payment of ₱' . number_format($billing->amount_due, 2) . ' for Bill #' . str_pad($billing->id, 6, '0', STR_PAD_LEFT) . ' has been approved and processed successfully.',
                    'type' => 'success'
                ]
            ]);
        } catch (\Exception $e) {
    ...
    public function reject(Request $request, $id)
    {
        try {
            ...
            try {
                ...
                // Log module lookup for debugging
                \Log::info('Payment rejection notification - Module lookup', [
                    'module_found' => $billingPaymentModule ? true : false,
                    'module_id' => $moduleId,
                    'module_name' => $billingPaymentModule ? $billingPaymentModule->module_name : 'NOT FOUND',
                    'user_id' => $billing->user->id
