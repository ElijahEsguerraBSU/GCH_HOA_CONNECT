...
Route::middleware('auth')->group(function() {
    ...
    // Admin chatbot management routes (requires authentication and permission)
    Route::middleware(['permission:guest chatbot'])->group(function() {
    ...
    Route::middleware(['permission:establishment management'])->group(function() {
        ...
        Route::post('business-management/upload-certification-template', [BusinessManagementController::class, 'uploadCertificationTemplate'])->name('businessmanagement.upload-certification-template');
        Route::get('business-management/download-certification-template', [BusinessManagementController::class, 'downloadCertificationTemplate'])->name('businessmanagement.download-certification-template');
    ...
    Route::middleware(['permission:vehicle management'])->group(function() {
        ...
        Route::post('vehicle-management/upload-sticker-form-template', [VehicleManagementController::class, 'uploadStickerFormTemplate'])->name('vehiclemanagement.upload-sticker-form-template');
        Route::get('vehicle-management/download-sticker-form-template', [VehicleManagementController::class, 'downloadStickerFormTemplate'])->name('vehiclemanagement.download-sticker-form-template');
        ...
        Route::post('vehicle-management/{id}/unarchive', [VehicleManagementController::class, 'unarchive'])->name('vehiclemanagement.unarchive');
    ...
    // Complaints routes (Service Request)
    Route::middleware(['permission:service request'])->group(function() {
    ...
    Route::middleware(['permission:service management'])->group(function() {
    ...
    Route::middleware(['permission:incident management'])->group(function() {
    ...
    Route::middleware(['permission:billing management'])->group(function() {
        ...
        // List of Payments routes (part of billing management)
    ...
    Route::middleware(['permission:feedback management'])->group(function() {
    ...
    Route::middleware(['permission:appointment management'])->group(function() {
    ...
    Route::middleware(['permission:appointment category'])->group(function() {
    ...
    Route::middleware(['permission:apply appointment'])->group(function() {
    ...
    Route::middleware(['permission:appointment allow schedule'])->group(function() {
    ...
    // Bank Account routes
    Route::middleware(['permission:payment account management'])->group(function() {
    ...
    // Incident routes (User-facing)
    Route::middleware(['permission:incident report'])->group(function() {
    ...
    // Announcement routes
    Route::middleware(['permission:announcements management'])->group(function() {
    ...
    Route::middleware(['permission:billing payment'])->group(function() {
        ...
        Route::get('billing-payment/{id}', [BillingPaymentController::class, 'show'])
            ->whereNumber('id')
    ...
    // Vehicle routes (User-facing)
    Route::middleware(['permission:vehicle'])->group(function() {
        Route::get('vehicle', [VehicleController::class, 'index'])->name('vehicle.index');
        Route::post('vehicle', [VehicleController::class, 'store'])->name('vehicle.store');
        Route::get('vehicle/download-sticker-form-template', [VehicleController::class, 'downloadStickerFormTemplate'])->name('vehicle.download-sticker-form-template');
    ...
    Route::middleware(['permission:notification settings'])->group(function() {
    ...
    Route::middleware(['permission:permission settings'])->group(function() {
    ...
    Route::middleware(['permission:message'])->group(function() {
        ...
        Route::post('chat/presence', [ChatController::class, 'updatePresence'])->name('chat.updatePresence');
        Route::get('chat/presence', [ChatController::class, 'getPresence'])->name('chat.getPresence');
    });

    // Business routes (User-facing)
    Route::middleware(['permission:apply business'])->group(function() {
        Route::get('business', [BusinessController::class, 'index'])->name('business.index');
        Route::post('business', [BusinessController::class, 'store'])->name('business.store');
        Route::get('business/download-certification-template', [BusinessController::class, 'downloadCertificationTemplate'])->name('business.download-certification-template');
    ...
    // Landlord routes (User-facing)
    Route::middleware(['permission:apply landlord'])->group(function() {
    ...
    Route::middleware(['permission:landlord management'])->group(function() {
        ...
        Route::post('landlord-management/{id}/unarchive', [\App\Http\Controllers\landlordmanagement\LandlordManagementController::class, 'unarchive'])->name('landlord-management.unarchive');
    });

    // Landlord Permission routes (View approved landlords)
    Route::middleware(['permission:landlord permissions'])->group(function() {
    ...
    // Users Login routes
    Route::middleware(['permission:user login'])->group(function() {
