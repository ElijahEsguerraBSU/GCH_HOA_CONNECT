...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2 gap-2">
        ...
        <!-- Description Filter -->
        <div class="dropdown"> 
            <button class="dropdown-toggle btn btn-outline-secondary" aria-expanded="false" data-tw-toggle="dropdown" id="descriptionFilterBtn">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 mr-2">
            ...
            <div class="dropdown-menu w-48"> 
                <ul class="dropdown-content"> 
                    <li> <a href="javascript:;" class="dropdown-item" data-filter-type="description" data-filter-value="all">All</a> </li> 
                    <li> <a href="javascript:;" class="dropdown-item" data-filter-type="description" data-filter-value="Monthly Dues">Monthly Dues</a> </li> 
                    <li> <a href="javascript:;" class="dropdown-item" data-filter-type="description" data-filter-value="Membership Fee">Membership Fee</a> </li> 
                    <li> <a href="javascript:;" class="dropdown-item" data-filter-type="description" data-filter-value="Others">Others</a> </li> 
                </ul> 
            </div> 
        </div>
                    ...
                    <td class="w-40">
                        <div class="flex items-center">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img alt="{{ $payment->user->name ?? 'Profile' }}" class="tooltip rounded-full" src="{{ optional($payment->user)->photo_url ?? asset('img/user.jpg') }}">
                            </div>
                            <div class="ml-3">
...
<div id="receipt-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header px-6 py-4 border-b border-slate-200 flex items-center justify-between">
                <h2 class="text-xl font-semibold text-slate-800" id="receipt-modal-title">Payment Receipt</h2>
                <button type="button" class="btn-close ml-auto" data-tw-dismiss="modal" aria-label="Close">
