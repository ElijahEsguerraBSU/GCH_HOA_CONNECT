...
.fc .fc-list-event.fc-event-forced-url:hover a {
    ...
    <body class="login">
            ...
            <div class="block xl:grid grid-cols-2 gap-4">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Enter the OTP sent to your email</div>
                        <div class="intro-x mt-8">
                            <input type="text" id="otp-input" class="intro-x login__input form-control py-3 px-4 block" placeholder="OTP">
                        </div>
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button id="otp-submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Verify OTP</button>
        ...
        <div class="intro-y col-span-12">
            <x-notification-toast id="otp_toast_success" type="success" title="Success" message="Action completed successfully"
                :showButton="false" />
            <x-notification-toast id="otp_toast_error" type="error" title="Error" :show-button="false">
                <div id="otp_error_message_slot" class="text-slate-500 mt-1"></div>
        ...
        @stack('scripts')
        <script src="{{ asset('js/otp/otp.js') }}"></script>
