...
<style>
    ...
    /* CRITICAL: Hide Week and Day view buttons completely */
    ...
    .fc-header-toolbar button[data-view="timeGridWeek"],
    .fc-header-toolbar button[data-view="timeGridDay"] {
        display: none !important;
        visibility: hidden !important;
        width: 0 !important;
        height: 0 !important;
    ...
    /* CRITICAL: Completely remove "all-day" text - hide it everywhere */
    ...
    /* AGGRESSIVE: Hide any text containing "all-day" */
    .fc-list-event-time:not([data-time-set="true"]) {
        font-size: 0 !important;
    }
    
    .fc-list-event-time:not([data-time-set="true"])::before {
        content: '' !important;
        display: none !important;
    }
    
    /* Hide all-day text completely */
    .fc-list-event-time[data-all-day="true"],
    .fc-list-event-time[aria-label*="all-day"],
    .fc-list-event-time[title*="all-day"] {
        visibility: hidden !important;
        opacity: 0 !important;
    }
    
    /* Ensure List view events are not marked as all-day */
    .fc-list-view .fc-list-event.fc-event-allday,
    .fc-list-view .fc-list-event[data-all-day="true"] {
        display: table-row !important;
    }
    
    /* Make sure time column is visible in List view */
    .fc-list-view table.fc-list-table {
        table-layout: auto !important;
    }
    
    /* CRITICAL: Make day headers (Monday, Tuesday, etc.) COMPLETELY not clickable */
    /* List view day headers - AGGRESSIVE */
    .fc-list-view .fc-list-day,
    .fc-list-view .fc-list-day-text,
    .fc-list-view .fc-list-day-side-text,
    .fc-list-view .fc-list-day a,
    .fc-list-view .fc-list-day-text a,
    .fc-list-view .fc-list-day-side-text a,
    .fc-list-view .fc-list-day * {
    ...
    /* Month view day headers - AGGRESSIVE */
    .fc-daygrid-day-header,
    .fc-daygrid-day-header *,
    .fc-col-header-cell,
    .fc-col-header-cell *,
    .fc-col-header-cell a,
    .fc-daygrid-day-header a {
        pointer-events: none !important;
        cursor: default !important;
        text-decoration: none !important;
        user-select: none !important;
    ...
    /* Remove ALL hover effects on day headers */
    .fc-list-view .fc-list-day:hover,
    .fc-list-view .fc-list-day-text:hover,
    .fc-list-view .fc-list-day-side-text:hover,
    .fc-daygrid-day-header:hover,
    ...
    /* Prevent any click events on day headers */
    .fc-list-view .fc-list-day,
    .fc-daygrid-day-header,
    .fc-col-header-cell {
