...
.fc .fc-list-event.fc-event-forced-url:hover a {
    ...
    <body class="login">
                ...
                <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                    <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                        ...
                        <div class="intro-x mt-8">
                            <input type="password" id="new-password-input" class="intro-x login__input form-control py-3 px-4 block" placeholder="New Password" minlength="8">
                        </div>
                        <div class="intro-x mt-5">
                            <input type="password" id="confirm-password-input" class="intro-x login__input form-control py-3 px-4 block" placeholder="Confirm New Password" minlength="8">
                        </div>
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            <button id="new-password-submit" class="btn btn-primary py-3 px-4 w-full xl:w-32 xl:mr-3 align-top">Reset Password</button>
        ...
        @stack('scripts')
        <script src="{{ asset('js/newpassword/newpassword.js') }}"></script>
