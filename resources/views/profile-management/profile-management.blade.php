    ...
    <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
            ...
            <div class="ml-5">
                ...
                <div class="text-slate-500">{{ $user->role == 'admin' ? 'GCH-HOA President' : ($user->role ?? 'User') }}</div>
            </div>
        </div>
        <div class="mt-6 lg:mt-0 flex-1 px-5 border-l border-r border-slate-200/60 dark:border-darkmode-400 border-t lg:border-t-0 pt-5 lg:pt-0">
            ...
            <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                <div class="flex items-start w-full min-w-0"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="mail" data-lucide="mail" class="lucide lucide-mail w-4 h-4 mr-2 flex-shrink-0 mt-0.5">
                        <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
                        <polyline points="22,6 12,13 2,6"></polyline>
                    </svg> 
                    <span class="break-words min-w-0 flex-1">{{ $user->email }}</span>
                </div>
                <div class="flex items-start w-full min-w-0 mt-3"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="phone" data-lucide="phone" class="lucide lucide-phone w-4 h-4 mr-2 flex-shrink-0 mt-0.5">
                        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path>
                    </svg> 
                    <span class="break-words min-w-0 flex-1">{{ $user->contact_number ?? 'Not provided' }}</span>
                </div>
                <div class="flex items-start mt-3 w-full min-w-0"> 
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" icon-name="map-pin" data-lucide="map-pin" class="lucide lucide-map-pin w-4 h-4 mr-2 flex-shrink-0 mt-0.5">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="intro-y box col-span-12 lg:col-span-6">
                <div class="flex items-center px-5 py-5 sm:py-3 border-b border-slate-200/60 dark:border-darkmode-400">
                    ...
                    <button class="btn btn-outline-secondary flex" id="editProfileBtn">Edit Profile</button>
                </div>
                <div class="p-5">
                    ...
                    <div id="profileDisplay">
                        <div class="space-y-5">
                            ...
                            <div class="mb-5">
                                ...
                                <div class="mt-1 text-slate-600" data-field="role">{{ $user->role == 'admin' ? 'GCH-HOA President' : ($user->role ?? 'Not provided') }}</div>
                            </div>
                            <!-- Gender -->
                            <div class="mb-5">
                                <label class="form-label font-medium">Gender</label>
                        ...
                        <div class="tenant-item border-b border-slate-200/60 py-4 last:border-b-0" data-tenant-id="{{ $tenant->id }}">
                            <div class="flex items-center">
                                <div class="w-12 h-12 flex-none image-fit">
                                    @if($tenant->photo)
                                    <img alt="{{ $tenant->full_name }}" class="rounded-full w-full h-full object-cover" src="{{ asset('storage/tenants/' . $tenant->photo) }}">
                                    @else
