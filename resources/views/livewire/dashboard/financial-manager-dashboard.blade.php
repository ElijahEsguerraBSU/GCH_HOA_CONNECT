<div>
    ...
    <div class="grid grid-cols-12 gap-6">
        ...
        <div class="col-span-12 mt-8">
            ...
            <!-- First Row: Total Users, Billing Items, and Approved Payments -->
            <div class="grid grid-cols-12 gap-6 mt-5 first-row-cards">
                <!-- Total Users Card -->
            ...
            <!-- Second Row: Pending Payments and Unpaid Items -->
            <div class="grid grid-cols-12 gap-6 mt-6 second-row-cards">
