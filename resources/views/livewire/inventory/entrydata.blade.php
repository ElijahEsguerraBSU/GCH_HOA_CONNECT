            ...
            <tbody>
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-15.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-9.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-10.jpg">
                            </div>
                        </div>
                    </td>
                    <td>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-6.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-12.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-3.jpg">
                            </div>
                        </div>
                    </td>
                    <td>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-2.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-6.jpg">
                            </div>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-4.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-15.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-14.jpg">
                            </div>
                        </div>
                    </td>
                    <td>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-1.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-8.jpg">
                            </div>
                        </div>
                    </td>
                    <td>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-11.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-10.jpg">
                            </div>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-13.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-15.jpg">
                            </div>
                ...
                <tr class="intro-x">
                    <td class="w-40">
                        <div class="flex">
                            ...
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-7.jpg">
                            </div>
                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                <img alt="" class="tooltip rounded-full" src="dist/images/preview-9.jpg">
                            </div>
