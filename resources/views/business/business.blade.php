...
<div class="grid grid-cols-12 gap-6 mt-5">
                                ...
                                <form id="addBusinessForm" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="grid grid-cols-12 gap-4">
                                        <div class="col-span-12 md:col-span-6">
                                            ...
                                            <input type="text" name="business_name" class="form-control" placeholder="e.g., ABC Restaurant" required>
                                        </div>
                                        <div class="col-span-12 md:col-span-6">
                                            <label class="form-label">Type of Business *</label>
                                            <input type="text" name="type_of_business" class="form-control" placeholder="e.g., Restaurant, Retail Store" required>
                                        </div>
                                        <div class="col-span-12">
                                            <label class="form-label">Address</label>
                                            <input type="text" name="address" class="form-control" placeholder="Business address (optional)">
                                        </div>
                                        
                                        <div class="col-span-12">
                                            <label class="form-label text-base font-semibold text-slate-700">Business Clearance</label>
                                            
                                            @if($hasCertificationTemplate)
                                            <div class="mb-4 mt-2 p-3 border border-slate-200 rounded-lg bg-slate-50">
                                                <label class="form-label text-sm font-medium text-slate-700 mb-2">Application For Certification</label>
                                                <p class="text-sm text-slate-600 mb-2">Download the Application For Certification, fill it out, and upload it with your other supporting documents below.</p>
                                                <a href="{{ route('business.download-certification-template') }}" class="btn btn-outline-primary btn-sm inline-flex items-center" download>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-4 h-4 mr-2">
                                            ...
                                            <div class="mt-4">
                                                <label class="form-label text-sm font-medium text-slate-600 mb-2">{{ $hasCertificationTemplate ? 'Upload Business Clearance (including filled Application For Certification)' : 'Business Clearance' }} <span class="text-danger">*</span></label>
                                                <input type="file" name="business_clearance[]" id="createBusinessClearance" class="form-control p-3 border border-slate-300 rounded-lg focus:border-blue-500 focus:ring-blue-500" accept=".pdf,.jpg,.jpeg,.png" multiple="multiple" required>
                                                <div class="text-xs text-slate-500 mt-1">You can select multiple files (maximum 5 files). <strong>Tip:</strong> Hold Ctrl (Windows) or Cmd (Mac) to select multiple files. Accepted formats: PDF, JPG, JPEG, PNG (Max: 2MB per file){{ $hasCertificationTemplate ? '. Include the filled Application For Certification.' : '' }}</div>
        ...
        <div class="intro-y col-span-12">
            ...
            <table class="table table-report -mt-2 min-w-full" id="businessTable">
                <thead>
                    <tr>
                ...
                <tbody>
                    @forelse ($businesses as $biz)
                        <tr class="intro-x" data-status="{{ $biz->status }}">
                        ...
                        <tr class="intro-x">
                            <td colspan="9" class="text-center py-8">
                                <div class="text-slate-500">
                                    ...
                                    <div class="text-sm">Start by adding your first business</div>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                        ...
                        <div class="text-left">
                            <form id="editBusinessForm">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-12">
                                        <label class="form-label text-base font-semibold text-slate-700">Business Clearance <span class="text-slate-400 text-sm">(Optional - upload only if you want to replace)</span></label>
                                        ...
                                        <div class="mt-4">
                                            <label class="form-label text-sm font-medium text-slate-600 mb-2">{{ $hasCertificationTemplate ? 'Upload Business Clearance (including filled Application For Certification)' : 'Business Clearance' }}</label>
                                            <input type="file" id="edit_business_clearance" name="business_clearance[]" class="form-control p-3 border border-slate-300 rounded-lg focus:border-blue-500 focus:ring-blue-500" accept=".pdf,.jpg,.jpeg,.png" multiple>
                                            <div class="text-xs text-slate-500 mt-1">You can select multiple files (maximum 5 files). Upload new files only if you want to replace the existing documents. Leave empty to keep current files.{{ $hasCertificationTemplate ? ' Include the filled Application For Certification.' : '' }}</div>
...
@push('styles')
<style>
    /* Fix for business clearance documents filename overflow in business modal */
    #view-business-modal .form-control {
    ...
    #view-business-modal #business-details .col-span-12 {
        max-width: 100% !important;
        min-width: 0 !important;
    }
    
    #view-business-modal #business-details .grid {
        max-width: 100% !important;
        overflow-x: hidden !important;
    }
    
    #view-business-modal #business-details a {
        max-width: 100% !important;
    ...
    #view-business-modal .modal-body {
        overflow-x: hidden !important;
        max-width: 100% !important;
    }
    
    #view-business-modal .modal-content {
        max-width: 100% !important;
        overflow-x: hidden !important;
    }
    
    @media (max-width: 768px) {
        #view-business-modal .modal-dialog {
