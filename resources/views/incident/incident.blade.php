        ...
        <table class="table table-report -mt-2">
            <thead>
                <tr>
                    ...
                    <th class="whitespace-nowrap">DESIGNATION OF THE PERSON INVOLVED</th>
                ...
                <tr class="intro-x">
                    ...
                    <td class="w-40">
                        <div class="flex items-center justify-center 
                            ...
                            @elseif($incident->status === 'Under Investigation') text-info
                            @elseif($incident->status === 'Resolved') text-success
                            @elseif($incident->status === 'Closed') text-slate-500
                            @else text-slate-500
                            @endif">
            ...
            <div class="modal-body px-5 py-10">
                <form id="report-incident-form" method="POST" action="{{ route('incident.store') }}">
                    ...
                    <div class="grid grid-cols-12 gap-4 gap-y-3">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <label for="designation" class="form-label">Designation of the Person Involved *</label>
                ...
                <form id="edit-incident-form" method="POST">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 md:col-span-6">
                            ...
                            <input type="text" name="person_involved_name" id="edit_person_involved_name" class="form-control" placeholder="Enter person you are reporting" required>
                        </div>
                        <div class="col-span-12 md:col-span-6">
                            <label class="form-label">Designation of the Person Involved *</label>
