...
<div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12">
            ...
            <style>
                ...
                /* Nationality dropdown styling - scrollable and not too long */
                .nationality-dropdown .ts-dropdown-content {
                    max-height: 250px !important;
                    overflow-y: auto !important;
                }
                
                .ts-dropdown.nationality-dropdown .ts-dropdown-content {
                    max-height: 250px !important;
                    overflow-y: auto !important;
                }
                
                /* Ensure dropdown is scrollable */
                .ts-wrapper.nationality-dropdown .ts-dropdown-content,
                .ts-dropdown-content {
                    max-height: 250px !important;
                    overflow-y: auto !important;
                }
                
                /* Remove red highlight/border when searching in nationality field */
                #nationality.tom-select .ts-input,
                #edit_nationality.tom-select .ts-input,
                #nationality.tom-select .ts-input input,
                #edit_nationality.tom-select .ts-input input,
                #nationality.tom-select .ts-input:focus,
                #edit_nationality.tom-select .ts-input:focus,
                #nationality.tom-select .ts-input.focus,
                #edit_nationality.tom-select .ts-input.focus,
                .tom-select#nationality .ts-input,
                .tom-select#edit_nationality .ts-input,
                .tom-select#nationality .ts-input input,
                .tom-select#edit_nationality .ts-input input,
                .tom-select#nationality .ts-input:focus,
                .tom-select#edit_nationality .ts-input:focus,
                .tom-select#nationality .ts-input.focus,
                .tom-select#edit_nationality .ts-input.focus {
                ...
                /* Remove validation red border from Tom Select wrapper */
                #nationality.tom-select.ts-wrapper,
                #edit_nationality.tom-select.ts-wrapper,
                .tom-select#nationality.ts-wrapper,
                .tom-select#edit_nationality.ts-wrapper {
                    border: none !important;
                    outline: none !important;
                }
                
                /* Remove red highlight from required field validation */
                #nationality:invalid,
                #edit_nationality:invalid,
                #nationality:invalid:focus,
                #edit_nationality:invalid:focus,
                select#nationality:invalid,
                select#edit_nationality:invalid,
                select#nationality:invalid:focus,
                select#edit_nationality:invalid:focus {
                    border-color: rgb(204, 204, 204) !important;
                    outline: none !important;
                    box-shadow: none !important;
                }
                
                /* Remove red border when form is validated */
                .was-validated #nationality:invalid,
                .was-validated #edit_nationality:invalid,
                .was-validated select#nationality:invalid,
                .was-validated select#edit_nationality:invalid {
                    border-color: rgb(204, 204, 204) !important;
                    box-shadow: none !important;
                }
                
                /* Remove red highlight from search matching text in dropdown options */
                /* Target all highlight spans within nationality dropdown options */
                .ts-dropdown .option .highlight,
                .ts-dropdown[data-selectable] .highlight,
                .ts-dropdown .option mark.highlight,
                .ts-dropdown .option span.highlight,
                .ts-dropdown .option em.highlight,
                .ts-dropdown .option strong.highlight {
                ...
                /* Specifically target nationality dropdown */
                body .ts-dropdown:has(.option:has(.highlight)) .option .highlight,
                body .ts-dropdown.nationality-dropdown .option .highlight {
                    background-color: transparent !important;
                    background: transparent !important;
                    color: inherit !important;
                    font-weight: 600 !important;
                ...
                /* Override any danger/red background colors */
                .ts-dropdown .option .highlight.bg-danger,
                .ts-dropdown .option .highlight[class*="bg-danger"],
                .ts-dropdown .option .highlight[class*="danger"] {
                    background-color: transparent !important;
                    background: transparent !important;
                    color: inherit !important;
                }
                            ...
                            <div class="mb-6">
                                ...
                                <div class="grid grid-cols-12 gap-4">
                                    ...
                                    <div class="col-span-12 md:col-span-4">
                                        ...
                                        <select name="nationality" id="nationality" class="tom-select form-control" data-placeholder="Select Nationality" required>
        ...
        <!-- END: Add Landlord Modal -->
            ...
            Showing <span id="filtered-count">{{ $landlords->count() }}</span> of <span id="total-count">{{ $landlords->total() }}</span> entries
            </div>
                ...
                @forelse ($landlords as $landlord)
                    <tr class="intro-x" data-status="{{ $landlord->status }}" data-id="{{ $landlord->id }}">
                        ...
                        <td class="text-center">{{ $landlord->unit_type }}</td>
                            ...
                            <td class="text-center">
                                @if($landlord->status === 'approved' && $landlord->business_clearance_attachments)
                                ...
                                @elseif($landlord->status === 'approved')
                                    <span class="text-slate-400 text-sm">No clearance uploaded</span>
                                @else
                            ...
                            <div class="flex justify-center items-center gap-2">
                                ...
                                @if($landlord->status !== 'approved' && $landlord->status !== 'declined')
                    ...
                    <form id="editLandlordForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-12 gap-4">
                                ...
                                <div class="col-span-12 md:col-span-4">
                                    <label class="form-label">Nationality *</label>
                                    <select name="nationality" id="edit_nationality" class="tom-select form-control" data-placeholder="Select Nationality" required>
                                        <option value="">Select Nationality</option>
                                        <option value="Afghan">Afghan</option>
                                        <option value="Albanian">Albanian</option>
                                        <option value="Algerian">Algerian</option>
...
@push('scripts')
    <script src="{{ asset('js/landlord/landlord.js') }}?v={{ time() }}"></script>
@endpush
